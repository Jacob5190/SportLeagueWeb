...
<div class="well well-lg">
    <div class="container">
        <h2><strong>ISL Executive Committee</strong></h2><br />
        <p class="lead">ISL Chair – Luke Walker  SCIE <a>luke.walker@scie.com.cn</a></p>
        <p class="lead">Co-Chair – Robert Nowak  MIS <a>Robert.nowak@merchiston.cn</a></p>
        <p class="lead">Co-Chair – Leon Tkachyk  VMA <a>leontkachyk@vma.edu.cn</a></p>
        <p class="lead">Treasurer – Ed Dawes  SCIE </p>
        <p class="lead">Under 11 Coordinator Andy Pounds  MIS</p>
    </div>
</div>
